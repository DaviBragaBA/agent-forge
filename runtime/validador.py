...
def validar(caminho_agente: str) -> bool:
    ...
    from contratos import _resolver_contrato
    ...
    arquivos_obrigatorios = {
        ...
        "loop.md": _resolver_contrato(caminho, "loop.md"),
        "planner.md": _resolver_contrato(caminho, "planner.md"),
        "executor.md": _resolver_contrato(caminho, "executor.md"),
        "toolbox.md": _resolver_contrato(caminho, "toolbox.md"),
    }
    ...
    toolbox = carregar_yaml_do_md(_resolver_contrato(caminho, "toolbox.md"))
