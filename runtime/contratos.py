...
def carregar_contratos(caminho_agente: Path) -> dict:
    ...
    return {
        ...
        "ciclo": carregar_yaml_do_md(_resolver_contrato(caminho_agente, "loop.md")),
        "planejador": carregar_yaml_do_md(_resolver_contrato(caminho_agente, "planner.md")),
        "caixa_ferramentas": carregar_yaml_do_md(_resolver_contrato(caminho_agente, "toolbox.md")),
        "executor": carregar_yaml_do_md(_resolver_contrato(caminho_agente, "executor.md")),
